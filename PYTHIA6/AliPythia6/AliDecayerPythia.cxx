...
AliDecayerPythia::AliDecayerPythia() : fPythia(AliPythia::Instance()),
                                       fDecay(kAll),
                                       fHeavyFlavour(kTRUE),
                                       fLongLived(kFALSE),
                                       fPatchOmegaDalitz(0),
...
AliDecayerPythia::AliDecayerPythia(const AliDecayerPythia &decayer) : AliDecayer(decayer),
                                                                      fPythia(0),
                                                                      fDecay(kAll),
                                                                      fHeavyFlavour(kTRUE),
                                                                      fLongLived(kFALSE),
